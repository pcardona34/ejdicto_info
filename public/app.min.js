...
function appendContextPath(contextPath,id){return(contextPath?contextPath+'.':'')+id;}},{}],23:[function(require,module,exports){module.exports=require("handlebars/runtime")["default"];},{"handlebars/runtime":2}],24:[function(require,module,exports){module.exports={"name":"ejdicto_info","version":"1.0.0","description":"Site de présentation de l'application ejDicto","main":"build/app.js","directories":{"lib":"lib"},"scripts":{"help":"bash ./outils.sh help","dev":"bash ./outils.sh dev","vendors":"bash ./outils.sh vendors","build":"bash ./outils.sh build","test":"bash ./outils.sh test","clean":"bash ./outils.sh clean","deploy":"bash ./outils.sh deploy"},"repository":{"type":"git","url":"git+https://github.com/pcardona34/ejdicto_info.git"},"keywords":["dictée","réécriture","exerciseur"],"author":"Patrick Cardona","license":"GPL-3.0-or-later","homepage":"https://github.com/pcardona34/ejdicto_info#readme","dependencies":{"chibijs":"^3.0.9"},"devDependencies":{"clean-css":"^4.2.3","handlebars":"^4.7.6","hbsfy":"^2.8.1","http-server":"^14.0.0","jsmin":"^1.0.1"}}},{}],25:[function(require,module,exports){var HandlebarsCompiler=require('hbsfy/runtime');module.exports=HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data){var stack1,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return"<div class=\"w3-display-container mySlides w3-center\">\n"
...
+"</div>\n";},"2":function(container,depth0,helpers,partials,data){return"  <div class=\"W3-display-middle demo\">\n  <h1 class=\"w3-text-teal w3-jumbo w3-center\">Allons-y !</h1>\n  <p><a class=\"w3-button w3-green w3-round w3-xxlarge w3-center\" \n  href=\"https://pcardona34.github.io/ejdicto\">ejDicto</a></p>\n </div>\n";},"4":function(container,depth0,helpers,partials,data){var alias1=container.lambda,alias2=container.escapeExpression,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return"  <img class=\"demo\" src=\"./static/images/ejdicto"
...
+" &ndash; &copy; 2020 Patrick Cardona <span class=\"w3-hide-small\">|</span> \n      Hébergement&nbsp;: <a title=\"site hébergeur\" \n      href=\"https://github.com\" \n      target=\"_blank\" rel=\"noreferrer noopener\" style=\"text-decoration: none\">\n      GitHub\n      </a>\n    </footer>";},"useData":true});},{"hbsfy/runtime":23}],27:[function(require,module,exports){var slideIndex=1;exports.slideIndex;exports.plusDivs=function(n){showDivs(slideIndex+=n);};exports.currentDiv=function(n){showDivs(slideIndex=n);};exports.showDivs=function(n){var i;var x=document.getElementsByClassName("mySlides");var dots=document.getElementsByClassName("demo");if(n>x.length){slideIndex=1}
if(n<1){slideIndex=x.length}
for(i=0;i<x.length;i=i+1){x[i].style.display="none";}
for(i=0;i<dots.length;i=i+1){dots[i].className=dots[i].className.replace(" w3-white","");}
x[slideIndex-1].style.display="block";dots[slideIndex-1].className+=" w3-white";};},{}],28:[function(require,module,exports){"use strict";const versionApp=require('../package.json').version;const MSG=require('../static/config/messages.json').msg;const IMG=require('../static/config/images.json').img;const Handlebars=require('hbsfy/runtime');const chibijs=require('chibijs');window.slideIndex=require('./lib/scripts/diaporama.js').slideIndex;window.plusDivs=require('./lib/scripts/diaporama.js').plusDivs;window.currentDiv=require('./lib/scripts/diaporama.js').currentDiv;window.showDivs=require('./lib/scripts/diaporama.js').showDivs;Handlebars.registerHelper("capitalisePremiereLettre",function(sChaine){if(typeof sChaine==='string'){return sChaine.charAt(0).toUpperCase()+sChaine.slice(1);}
return null;});Handlebars.registerHelper('encodeChaine',function(chaine){return new Handlebars.SafeString(chaine);});Handlebars.registerHelper("indexPlusUn",function(index){let indice=0;if(typeof index==='integer'){indice=index+1;}else{indice=parseInt(index,10);indice=indice+1;}
return indice;});Handlebars.registerPartial("diaporama",require('./composants/diaporamaTemplate.hbs'));const accueilTemplate=require("./pages/accueilTemplate.hbs");const piedDePageTemplate=require("./composants/piedTemplate.hbs");window.addEventListener('load',()=>{const app=$('#app');const piedDePage=piedDePageTemplate({'version':versionApp});let contenu={};contenu.bienvenue=MSG.bienvenue;contenu.img=IMG;let html=accueilTemplate(contenu);console.log(html);app.html(html);showDivs(slideIndex);app.htmlAppend(piedDePage);});},{"../package.json":24,"../static/config/images.json":30,"../static/config/messages.json":31,"./composants/diaporamaTemplate.hbs":25,"./composants/piedTemplate.hbs":26,"./lib/scripts/diaporama.js":27,"./pages/accueilTemplate.hbs":29,"chibijs":1,"hbsfy/runtime":23}],29:[function(require,module,exports){var HandlebarsCompiler=require('hbsfy/runtime');module.exports=HandlebarsCompiler.template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data){var stack1,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
...
+" </div> \n\n";},"usePartial":true,"useData":true});},{"hbsfy/runtime":23}],30:[function(require,module,exports){module.exports={"img":[{"indice":1,"legende":"Page d'accueil"},{"indice":2,"legende":"Liste filtrée"},{"indice":3,"legende":"Mode d'emploi"},{"indice":4,"legende":"Écoute d'une dictée"},{"indice":5,"legende":"Saisie d'une dictée"},{"indice":6,"legende":"Bilan intermédiaire"},{"indice":7,"legende":"Affichage de la correction"},{"indice":8,"legende":"Gestion du profil"},{"indice":9,"legende":"Liste des dictées aménagées"},{"indice":10,"legende":"Assistant de la saisie"},{"indice":11,"legende":"mentions légales"},{"indice":12,"legende":"Liste des réécritures"},{"indice":13,"legende":"Mode d'emploi d'une réécriture"},{"indice":14,"legende":"Une réécriture : consigne et texte initial"},{"indice":15,"legende":"Aide : conseils pour améliorer sa saisie"},{"indice":16,"legende":"Interface mobile"},{"indice":17,"legende":"Affichage du menu des actions"},{"indice":18,"legende":"<a href='https://pcardona34.github.io/ejdicto' class='w3-button'>Allons-y !</a>"}]}},{}],31:[function(require,module,exports){module.exports={"msg":{"bienvenue":"<a href='https://pcardona34.github.io/ejdicto'>ejDicto</a>, espace d'entrainement en orthographe&nbsp;!"}}},{}]},{},[28]);